    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            _self.getData(function() {
                _self.selector.addEventListener('click', popupArea);
            });
        },
        //重置节点个数
        ...
        finish: function(e) {
            ...
            //_self.selector.value = provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):(''));
            _self.selector.value = provinceText + ((cityText)?(',' + cityText):(''));

            if (document.getElementById('demo2')) {
                document.getElementById('demo2').textContent = cityText;
            } else if (document.getElementById('place')) {
                document.getElementById('place').value = _self.selector.value;
            }
        ...
        close: function(e) {
            ...
            _self.selector.dispatchEvent(evt);
