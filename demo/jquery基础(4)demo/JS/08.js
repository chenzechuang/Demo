...
(function($) {
  $.slideFadeIn = function($object){
    $object.fadeOut('slow').slideDown('slow');
  },
  $.slideFadeOut = function($object){
    $object.slideUp('slow').fadeIn('slow');
 };
...
$(document).ready(function() {
  ...
  $('a').tooltip({offsetX: -30, offsetY: 25})
});
